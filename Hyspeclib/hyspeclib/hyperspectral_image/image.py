...
import numpy as np
from Hyspeclib.hyspeclib.hyperspectral_image.check_memory import check_memory
...
class image:
    ...
    def __init__(self, img_path):
        ...
        """
        self._read_only_image = envi.open(img_path + ".hdr", img_path)
    ...
    def load_image(self):
        ...
        if mem.check_image_before_load(self.size):
            ...
            self._loaded_img = envi.open(self.img_path + ".hdr", self.img_path).load()
