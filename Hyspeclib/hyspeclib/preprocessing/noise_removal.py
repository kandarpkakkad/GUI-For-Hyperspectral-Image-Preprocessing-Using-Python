from Hyspeclib.hyspeclib.hyperspectral_image import read_image
...
class noise_removal:
    ...
    def __init__(self, image, ndvi_threshold = 125, NIR = 90 , RED = 55, min_threshold = 0, max_threshold = 1, data_ignore_value=-9999.0):

        self._image = read_image(image)

        self._height = self._image.img_height

        self._width = self._image.img_width

        self._bands = self._image.img_bands
